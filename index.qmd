...
dreamy_color = "#4E79A7"
duck_color = "#E15759"
dreamy_name = "Doc Dreamy"
duck_name = "Doc Duck"

df = patients_df
dreamy_mask = df["doctor_name"] == dreamy_name
duck_mask = df["doctor_name"] == duck_name

dreamy_pts = df.loc[dreamy_mask]
duck_pts = df.loc[duck_mask]

mean_dreamy = dreamy_pts["post_surgical_score"].mean()
mean_duck = duck_pts["post_surgical_score"].mean()
